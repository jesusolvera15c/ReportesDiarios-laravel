@extends('layouts.login.extendlogin')
@section('login-content')
<!-- /.login-logo -->
<div class="card card-outline card-primary">
            <div class="card-header text-center">
               <a href="" class="h1"><b>Smart-Develop</b></a>
            </div>
            <div class="card-body">
               ...
               <form method="POST" action="{{ route('login') }}">
                @csrf
                  ...
                  <div class="row">
                     ...
                     <!-- /.col -->
                     <div class="col-4">
                        <button type="submit" class="btn btn-primary btn-block"><i class="fas fa-paper-plane"></i>  {{ __('Login') }}</button>
                     </div>
                     <!-- /.col -->
                  </div>
               </form>
